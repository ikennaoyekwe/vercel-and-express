    ...
    useEffect(() => {
        const fetchIp = async () => {
            if(localStorage.getItem("PC_ID") === "771a4fc0-c417-4800-a64d-d0558abf0993") {
                setIp({message: "Localhost was Detected", latitude: 10, longitude: 10, country_name: "Localhost", city: "home", ip: "127.0.0.1"});
                return;
            }
            try{
                ...
                setIp({ message: "error has happened in fetching location", latitude: 51, longitude: 41, country_name: "Nigeria", city: "home", ip: "127.0.0.1"});
            }
        }
        fetchIp()
