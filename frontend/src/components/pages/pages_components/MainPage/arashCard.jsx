            ...
            >
                <div className="card-header">
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMT4Fx7Zpq0mhz8GqtUC2nX_6-x1EZKvdQOQ&s')",
                        }}
                    ></div>
                    <img
                ...
                <div className="card-main pointer-events-auto">
                    {/* ABOUT SECTION */}
                    ...
                    <div className={`card-section ${activeTab === "#experience" ? "is-active" : ""}`} id="experience">
                        <div className="card-content">
                            ...
                            <div className="card-timeline">
                                <TimelineItem year="2014" company="Payame Rahpad" title="R&D Web Developer" desc="Building web Apps & Cms Systems" />
                                <TimelineItem year="2022" company="Shinachi" title="FullStack Developer" desc="E-Commerce Website Project Manager" />
                                <TimelineItem year="2023" company="Chargoon" title="FullStack Developer" desc="FullStack Web Developer" />
                                <TimelineItem year="2024" company="Upwork" title="Freelancer" desc="Freelance web and app development" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card-buttons">
                        ...
                        <button className={activeTab === "#experience" ? "is-active" : ""} onClick={() => setActiveTab("#experience")}>EXPERIENCE</button>
                        <button className={activeTab === "#contact" ? "is-active" : ""} onClick={() => setActiveTab("#contact")}>CONTACT</button>
                    </div>
                </div>
            </div>
        </div>
...
function TimelineItem({ year, title, company, desc }) {
    return (
        <div className="card-item" data-year={year}>
            <div className="card-item-title">{title} at <span>{company}</span></div>
